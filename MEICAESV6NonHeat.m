%========================================================================
%  Function: Dispatch of Zero-Carbon-Emisssion Micro Energy Internet
%  Author: Li Rui
%  Version: 1.5
%  Data: 2016/04/19 PDN
%        2016/05/26 PDN + OLTC
...
%        2016/06/19 revise the active power equation by adding power consumption of heat pump 
%        2016/09/07 revise the SOC of TES of CAES figure
%        2016/09/17 consider the active power loss and reactive power loss
%        of DistFlow model
%        2016/09/17 consider the SOCP constraint of DistFlow model to
%        convert the original MILP model as a MISOCP one
%========================================================================
clc
close all
clear all
